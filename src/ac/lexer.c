...
static ac_token_info token_infos[] = {
    ...
    { true,  ac_token_type_ATOMIC, IDENT("_Atomic") },
    { true,  ac_token_type_AUTO, IDENT("auto") },
    { true,  ac_token_type_BOOL, IDENT("bool") },
    ...
    { true,  ac_token_type_CONST, IDENT("const") },
    ...
    { true,  ac_token_type_EXTERN, IDENT("extern") },
    ...
    { true,  ac_token_type_INLINE, IDENT("inline") },
    ...
    { true,  ac_token_type_REGISTER, IDENT("register") },
    { true,  ac_token_type_RESTRICT, IDENT("restrict") },
    ...
    { true,  ac_token_type_STATIC, IDENT("static") },
    ...
    { true,  ac_token_type_THREAD_LOCAL, IDENT("thread_local") },
    { true,  ac_token_type_THREAD_LOCAL2, IDENT("_Thread_local") },
    ...
    { true,  ac_token_type_VOID, IDENT("void") },
    { true,  ac_token_type_VOLATILE, IDENT("volatile") },
